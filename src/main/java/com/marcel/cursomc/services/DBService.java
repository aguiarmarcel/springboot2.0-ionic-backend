...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Estado est3 = new Estado(null, "Rio Grande do Norte");
		
		Cidade c1 = new Cidade(null, "Uberlândia", est1);
		Cidade c2 = new Cidade(null, "São Paulo", est2);
		Cidade c3 = new Cidade(null, "Campinas", est2);
		Cidade c4 = new Cidade(null, "Natal", est3);
		...
		Cliente cli1 = new Cliente(null, "Eduarda Aguiar", "aguiar.marcel.bezerra@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Marcel Bezerra", "aguiar_marcel@hotmail.com", "03385220424", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("84996156891", "34252625"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "281777012", cli2, c2);
		Endereco e4 = new Endereco(null, "Rua Desembargador Dionisio Filgueira", "764", null, "Petrópolis", "281555012", cli2, c4);
